...
class JxxDialogApplication final : public wxApp
{
public:
...
wxIMPLEMENT_APP_NO_MAIN(JxxDialogApplication);
...
namespace
{
    ...
    public:
        ...
        explicit CloseListener(
            const ::jxx::Ptr<::jxx::awt::Dialog>& dialog)
            : dialog_(dialog)
        {
        }
    ...
    int runApplication()
    {
        ...
        auto dialog = ::jxx::NEW<::jxx::awt::Dialog>(
            frame,
            text("JXX Modal Dialog"),
            true);
        dialog->setLayout(::jxx::NEW<::jxx::awt::FlowLayout>());
        dialog->setBounds(150, 150, 300, 140);

        auto openButton =
            ::jxx::NEW<::jxx::awt::Button>(text("Open Dialog"));
        openButton->setSize(140, 32);
        openButton->addActionListener(
            ::jxx::NEW<OpenListener>(dialog));
        frame->add(openButton);

        auto closeButton =
            ::jxx::NEW<::jxx::awt::Button>(text("Close"));
        closeButton->setSize(100, 32);
        closeButton->addActionListener(
            ::jxx::NEW<CloseListener>(dialog));
