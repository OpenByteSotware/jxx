...
namespace jxx::awt {
class Button : public ::jxx::lang::ClassBase<Button,Component> {
public:
 using JxxSuper=Component; using Super=::jxx::lang::ClassBase<Button,JxxSuper>;
 Button(); explicit Button(const ::jxx::Ptr<::jxx::lang::String>& label); ~Button() override=default;
 ::jxx::Ptr<::jxx::lang::String> getLabel() const; void setLabel(const ::jxx::Ptr<::jxx::lang::String>& label);
...
private: ::jxx::Ptr<::jxx::lang::String> label_; ::jxx::Ptr<::jxx::lang::String> actionCommand_; std::vector<::jxx::Ptr<::jxx::awt::event::ActionListener>> listeners_;
}; }
