...
namespace jxx::awt
{
    ...
    class Component :
        public ::jxx::lang::ClassBase<Component, ::jxx::lang::Object>
    {
    public:
        using JxxSuper = ::jxx::lang::Object;
        using Super = ::jxx::lang::ClassBase<Component, JxxSuper>;

        virtual ~Component() = 0;

        virtual ::jxx::lang::jbool isVisible() const;
        virtual void setVisible(::jxx::lang::jbool visible);
        virtual ::jxx::lang::jbool isEnabled() const;
        virtual void setEnabled(::jxx::lang::jbool enabled);
        virtual ::jxx::lang::jint getX() const;
        virtual ::jxx::lang::jint getY() const;
        virtual ::jxx::lang::jint getWidth() const;
        virtual ::jxx::lang::jint getHeight() const;
        virtual ::jxx::Ptr<Point> getLocation() const;
        virtual void setLocation(const ::jxx::Ptr<Point>& point);
        virtual void setLocation(::jxx::lang::jint x, ::jxx::lang::jint y);
        virtual ::jxx::Ptr<Dimension> getSize() const;
        virtual void setSize(const ::jxx::Ptr<Dimension>& dimension);
        virtual void setSize(::jxx::lang::jint width, ::jxx::lang::jint height);
        virtual ::jxx::Ptr<Rectangle> getBounds() const;
        virtual void setBounds(const ::jxx::Ptr<Rectangle>& rectangle);
        virtual void setBounds(::jxx::lang::jint x, ::jxx::lang::jint y,
            ::jxx::lang::jint width, ::jxx::lang::jint height);
        virtual ::jxx::Ptr<Color> getForeground() const;
        virtual void setForeground(const ::jxx::Ptr<Color>& color);
        virtual ::jxx::Ptr<Color> getBackground() const;
        virtual void setBackground(const ::jxx::Ptr<Color>& color);
        virtual ::jxx::Ptr<Font> getFont() const;
        virtual void setFont(const ::jxx::Ptr<Font>& font);
        ...
        virtual ::jxx::lang::jbool isValid() const;
    ...
    private:
        ...
        void setParentInternal(const ::jxx::Ptr<Container>& parent);
        ...
        ::jxx::lang::jint x_ = 0;
        ::jxx::lang::jint y_ = 0;
        ::jxx::lang::jint width_ = 0;
        ::jxx::lang::jint height_ = 0;
        ::jxx::lang::jbool visible_ = true;
        ::jxx::lang::jbool enabled_ = true;
        ::jxx::lang::jbool valid_ = false;
        ::jxx::Ptr<Color> foreground_;
