...
public:
    using JxxSuper=::jxx::lang::Object; using Super=::jxx::lang::ClassBase<Component,JxxSuper>;
    virtual ~Component()=0;
    virtual ::jxx::lang::jbool isVisible() const; virtual void setVisible(::jxx::lang::jbool visible);
    virtual ::jxx::lang::jbool isEnabled() const; virtual void setEnabled(::jxx::lang::jbool enabled);
    ...
    virtual ::jxx::Ptr<Color> getForeground() const; virtual void setForeground(const ::jxx::Ptr<Color>& color);
    virtual ::jxx::Ptr<Color> getBackground() const; virtual void setBackground(const ::jxx::Ptr<Color>& color);
    virtual ::jxx::Ptr<Font> getFont() const; virtual void setFont(const ::jxx::Ptr<Font>& font);
    virtual ::jxx::Ptr<::jxx::lang::String> getName() const; virtual void setName(const ::jxx::Ptr<::jxx::lang::String>& name);
...
private:
    ...
    ::jxx::lang::jint x_=0,y_=0,width_=0,height_=0; ::jxx::lang::jbool visible_=true,enabled_=true,valid_=false;
    ::jxx::Ptr<Color> foreground_; ::jxx::Ptr<Color> background_; ::jxx::Ptr<Font> font_; ::jxx::Ptr<::jxx::lang::String> name_; std::weak_ptr<Container> parent_;
}; }
