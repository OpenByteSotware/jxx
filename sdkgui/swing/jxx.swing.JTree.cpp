...
#include "swing/tree/jxx.swing.tree.DefaultMutableTreeNode.h"
namespace jxx::swing
{
    JTree::JTree():JTree(::jxx::NEW<::jxx::swing::tree::DefaultTreeModel>(::jxx::NEW<::jxx::swing::tree::DefaultMutableTreeNode>())){} JTree::JTree(const ::jxx::Ptr<::jxx::swing::tree::TreeModel>& m):Super(){setModel(m);} void JTree::setModel(const ::jxx::Ptr<::jxx::swing::tree::TreeModel>& m){if(!m)throw ::jxx::lang::NullPointerException("model");model_=m;clearSelection();expanded_.clear();expanded_.push_back(0);} ::jxx::Ptr<::jxx::swing::tree::TreeModel> JTree::getModel()const{return model_;}
