...
namespace jxx::swing
{
	...
	JTree(); explicit JTree(const ::jxx::Ptr<::jxx::swing::tree::TreeModel>& model);
	void setModel(const ::jxx::Ptr<::jxx::swing::tree::TreeModel>& model);
	::jxx::Ptr<::jxx::swing::tree::TreeModel> getModel()const; 
	...
	void collapseRow(::jxx::lang::jint row); ::jxx::lang::jbool isExpanded(::jxx::lang::jint row)const; ::jxx::Ptr<::jxx::awt::Dimension> getPreferredScrollableViewportSize()const; private:
		::jxx::Ptr<::jxx::swing::tree::TreeModel> model_; 
