...
namespace jxx::swing
{
    ...
    JToggleButton::JToggleButton(const ::jxx::Ptr<::jxx::lang::String>& text)
        : Super(text) {}
    ...
    ::jxx::lang::jbool JToggleButton::isSelected() const
    { return AbstractButton::isSelected(); }
    void JToggleButton::setSelected(::jxx::lang::jbool value)
    {
        if (const auto group = group_.lock())
            group->setSelected(::jxx::CAST<JToggleButton>(thisPtr()), value);
        else
            AbstractButton::setSelected(value);
    }
    void JToggleButton::setSelectedFromGroup(::jxx::lang::jbool value)
    { AbstractButton::setSelected(value); }
    void JToggleButton::doClick()
    {
