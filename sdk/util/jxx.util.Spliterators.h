...
class Spliterators : public ::jxx::lang::ClassBase<Spliterators, ::jxx::lang::Object> {
private:
...
public:
    ...
    static ::jxx::Ptr<::jxx::util::Spliterator<E>> forArray(
        ...
        const ::jxx::Ptr<::jxx::util::ComparatorSuper<E>>& comparator = nullptr) {
        if (array == nullptr) {
    ...
    static ::jxx::Ptr<::jxx::util::Spliterator<E>> forIterator(
        const ::jxx::Ptr<::jxx::util::Iterator<E>>& iterator,
    ...
    static ::jxx::Ptr<::jxx::util::Spliterator<E>> forSortedSet(
        const ::jxx::Ptr<::jxx::util::Iterator<E>>& iterator,
        ::jxx::lang::jlong size,
        const ::jxx::Ptr<::jxx::util::ComparatorSuper<E>>& comparator,
        ::jxx::lang::jint extraCharacteristics = 0) {
        return forIterator<E>(
            iterator,
            size,
    ...
    static ::jxx::Ptr<::jxx::util::Spliterator<K>> forKeyIterator(
        ...
        ::jxx::lang::jlong size,
        ::jxx::lang::jint extraCharacteristics = 0,
        const ::jxx::Ptr<::jxx::util::ComparatorSuper<K>>& comparator = nullptr) {
