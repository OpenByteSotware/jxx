...
public:
    ...
    explicit ArrayDeque(::jxx::lang::jint numElements)
        : data_()
        , modCount_(0) {
        if (numElements < 0) throw ::jxx::lang::IllegalArgumentException();
    ...
    virtual ::jxx::lang::jbool contains(const ::jxx::Ptr<::jxx::lang::Object>& o) override {
        for (const auto& e : data_) {
            ...
            } else if (e != nullptr & o->equals(::jxx::CAST<::jxx::lang::Object>(e))) {
                return true;
            }
        }
        return false;
    ...
    public:
        ...
        virtual ::jxx::Ptr<E> next() override {
            ...
            if (index_ >= owner_->size()) throw ::jxx::util::NoSuchElementException();
            lastRet_ = index_;
            return owner_->data_[index_++];
        }

        virtual void remove() override {
            if (lastRet_ < 0) throw ::jxx::lang::IllegalStateException();
            checkForComodification();
    ...
    private:
        void checkForComodification() {
            if (owner_->modCount_ != expectedModCount_) throw ::jxx::util::ConcurrentModificationException();
        }
    };
    ...
    public:
        ...
        virtual ::jxx::Ptr<E> next() override {
            checkForComodification();
            if (index_ < 0) throw ::jxx::util::NoSuchElementException();
            lastRet_ = index_;
            return owner_->data_[index_--];
        }
    ...
    virtual ::jxx::lang::ObjectArray toArray() override {
        ...
        for (::jxx::lang::jint i = 0; i < size(); ++i) {
            (*result)[i] = ::jxx::CAST<::jxx::lang::Object>(data_[static_cast<std::size_t>(i)]);
        }
        return result;
    }
    ...
    virtual ::jxx::lang::jbool offerFirst(const ::jxx::Ptr<E>& e) override {
        if (e == nullptr) throw ::jxx::lang::NullPointerException();
        data_.push_front(e);
        ++modCount_;
        return true;
    }
    ...
    virtual void addFirst(const ::jxx::Ptr<E>& e) override {
        if (!offerFirst(e)) throw ::jxx::lang::IllegalStateException();
    }

    virtual void addLast(const ::jxx::Ptr<E>& e) override {
        if (!offerLast(e)) throw ::jxx::lang::IllegalStateException();
    }
