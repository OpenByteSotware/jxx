...
namespace jxx::util {
    ...
    public:
        ...
        template <typename T>
        static void shuffle(const ::jxx::Ptr<List<T>>& list, const ::jxx::Ptr<::jxx::util::Random>& random) {
        ...
        template <typename T>
        static void sort(
            const ::jxx::Ptr<List<T>>& list,
            const ::jxx::Ptr<ComparatorSuper<T>>& comparator) {
        ...
        static ::jxx::lang::jbool disjoint(
            ...
            const ::jxx::Ptr<wildcard::CollectionAny>& second) {
        ...
        template <typename T>
        static void fill(const ::jxx::Ptr<List<T>>& list, const ::jxx::Ptr<T>& value) {
            if (list == nullptr) {
                throw ::jxx::lang::NullPointerException();
            }
        ...
        static ::jxx::lang::jbool replaceAll(
            const ::jxx::Ptr<List<T>>& list,
            const ::jxx::Ptr<T>& oldValue,
            const ::jxx::Ptr<T>& newValue) {
