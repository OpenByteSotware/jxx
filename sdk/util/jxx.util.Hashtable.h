...
namespace jxx::util
{
	...
	class Hashtable : public ::jxx::lang::ClassBase<Hashtable<K, V>,
	...
	private:
		...
		void insertNew_(const ::jxx::Ptr<K>& key, const ::jxx::Ptr<V>& value)
		{
		...
		class EntryView final : public virtual MapEntry<K, V>
		{
			...
			::jxx::Ptr<K> key_;
		public:
			EntryView(Hashtable<K, V>* owner, const ::jxx::Ptr<K>& key) : owner_(owner), key_(key)
			{
			}
			::jxx::Ptr<K> getKey() override
			{
				return key_;
			}
			::jxx::Ptr<V> getValue() override
			{
		...
		public:
			...
			::jxx::Ptr<Iterator<K>> iterator() override
			{
		...
		public:
			...
			::jxx::Ptr<Iterator<V>> iterator() override
			{
			...
			return this->synchronized([&]
	{
		...
		::jxx::lang::jbool isEmpty() override
		{
			return this->synchronized([&]
	{
			return static_cast<::jxx::lang::jbool>(size_ == 0);
	 });
		}
			...
			auto snapshot = this->synchronized([&]
	{
		...
		::jxx::lang::jbool contains(const ::jxx::Ptr<::jxx::lang::Object>& value)
		{
			...
			return this->synchronized([&]
	{
		...
		::jxx::lang::jbool containsKey(const ::jxx::Ptr<::jxx::lang::Object>& key) override
		{
			return this->synchronized([&]
	{
			return static_cast<::jxx::lang::jbool>(find_(key) != nullptr);
	 });
		}
		...
		::jxx::Ptr<V> get(const ::jxx::Ptr<::jxx::lang::Object>& key) override
		{
			return this->synchronized([&]
	{
			auto* r = find_(key); return r == nullptr ? ::jxx::Ptr<V>(nullptr) : r->value;
	 });
		}
			...
			return this->synchronized([&]
	{
			...
			if (r != nullptr) {
				auto old = r->value; r->value = value; return old;
			}
			...
			return this->synchronized([&]
	{
		...
		{
			if (source == nullptr)throw ::jxx::lang::NullPointerException();
			auto it = source->entrySet()->iterator(); while (it->hasNext()) {
				auto e = it->next();
	...
	{
			if (size_ != 0) {
				for (auto& b : buckets_)b.clear(); size_ = 0; ++modCount_;
			}
	});
		}
		...
		::jxx::Ptr<Set<K>> keySet() override
		{
			return this->synchronized([&]
	{
			if (keySet_ == nullptr)keySet_ = ::jxx::NEW<KeySetView>(this); return keySet_;
	});
		}
		...
		::jxx::Ptr<Collection<V>> values() override
		{
			return this->synchronized([&]
	{
			if (values_ == nullptr)values_ = ::jxx::NEW<ValuesView>(this); return values_;
	});
		}
		...
		::jxx::Ptr<Set<MapEntry<K, V>>> entrySet() override
		{
			return this->synchronized([&]
	{
			if (entrySet_ == nullptr)entrySet_ = ::jxx::NEW<EntrySetView>(this); return entrySet_;
	});
		}

		::jxx::Ptr<V> getOrDefault(
            const ::jxx::Ptr<::jxx::lang::Object>& key,
            const ::jxx::Ptr<V>& defaultValue)
		{
            ...
            const ::jxx::Ptr<V>& value) override
		{
			...
			return this->synchronized([&]
	{
			auto* r = find_(object_(key)); if (r != nullptr)return r->value; insertNew_(key, value); return ::jxx::Ptr<V>(nullptr);
	});
		}
            ...
            const ::jxx::Ptr<::jxx::lang::Object>& value)
		{
			...
			return this->synchronized([&]
	{
			auto* r = find_(key); if (r == nullptr || !equalObjects_(valueObject_(r->value), value))return static_cast<::jxx::lang::jbool>(false); remove(key); return static_cast<::jxx::lang::jbool>(true);
	});
		}
            ...
            const ::jxx::Ptr<V>& newValue) override
		{
			...
			return this->synchronized([&]
	{
			auto* r = find_(object_(key)); if (r == nullptr || !equalObjects_(valueObject_(r->value), valueObject_(oldValue)))return static_cast<::jxx::lang::jbool>(false); r->value = newValue; return static_cast<::jxx::lang::jbool>(true);
	});
		}
            ...
            const ::jxx::Ptr<V>& value) override
		{
			...
			return this->synchronized([&]
	{
			auto* r = find_(object_(key)); if (r == nullptr)return ::jxx::Ptr<V>(nullptr); auto old = r->value; r->value = value; return old;
	});
		}
		...
		::jxx::lang::jint hashCode() const override
		{
			return this->synchronized([&]
	{
			::jxx::lang::jint h = 0; for (const auto& b : buckets_)for (const auto& r : b)h += hash_(object_(r.key)) ^ hash_(valueObject_(r.value)); return h;
	});
		}
		...
		::jxx::Ptr<::jxx::lang::Object> clone()
		{
			...
			this->synchronized([&]
	{
			for (const auto& b : buckets_)for (const auto& r : b)copy->put(r.key, r.value);
	});
	...
	private:
		...
		::jxx::lang::jbool removeFirstValue_(const ::jxx::Ptr<::jxx::lang::Object> value)
		{
			...
			return this->synchronized([&]
	{
			for (auto& b : buckets_)for (auto i = b.begin(); i != b.end(); ++i)if (equalObjects_(valueObject_(i->value), value)) {
				b.erase(i); --size_; ++modCount_; return static_cast<::jxx::lang::jbool>(true);
			}return static_cast<::jxx::lang::jbool>(false);
	});
		}
	};
