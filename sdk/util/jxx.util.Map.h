...
public:
    ...
    virtual jxx::Ptr<V> getOrDefault(const jxx::Ptr<jxx::lang::Object> key, jxx::Ptr<V> defaultValue) {
        jxx::Ptr<V> v = get(key);
    ...
    virtual jxx::Ptr<V> putIfAbsent(const jxx::Ptr<K> key, jxx::Ptr<V> value) {
        jxx::Ptr<V> v = get(key);
        if (v == nullptr) v = put(key, value);
        return v;
    }

    virtual jxx::lang::jbool remove(const jxx::Ptr<jxx::lang::Object> key, jxx::Ptr<jxx::lang::Object> value) {
    ...
    virtual jxx::lang::jbool replace(const jxx::Ptr<K> key, jxx::Ptr<V> oldValue, jxx::Ptr<V> newValue) {
        jxx::Ptr<V> cur = get(key);
    ...
    virtual jxx::Ptr<V> replace(const jxx::Ptr<K> key, jxx::Ptr<V> value) {
        jxx::Ptr<V> cur = get(key);
        if (cur != nullptr || containsKey(key)) return put(key, value);
        return nullptr;
    }

    virtual jxx::Ptr<V> computeIfAbsent(const jxx::Ptr<K> key, jxx::Ptr<function::Function<K, V>> mappingFunction) {
    ...
    virtual jxx::Ptr<V> computeIfPresent(const jxx::Ptr<K> key, jxx::Ptr<function::BiFunction<K, V, V>> remappingFunction) {
    ...
    virtual jxx::Ptr<V> compute(const jxx::Ptr<K> key, jxx::Ptr<function::BiFunction<K, V, V>> remappingFunction) {
        if (remappingFunction == nullptr) throw jxx::lang::NullPointerException();
        jxx::Ptr<V> oldValue = get(key);
        jxx::Ptr<V> newValue = remappingFunction->apply(key, oldValue);
        if (newValue == nullptr) {
    ...
    virtual jxx::Ptr<V> merge(const jxx::Ptr<K> key, jxx::Ptr<V> value, jxx::Ptr<function::BiFunction<V, V, V>> remappingFunction) {
