...
public:
 ...
 void put(const ::jxx::Ptr<E>& e) override { require_(e); if(::jxx::lang::Thread::interrupted()) throw ::jxx::lang::InterruptedException(); std::unique_lock<std::mutex> l(m_); cv_.wait(l,[&]{return waitingConsumers_>0&&!slot_;}); slot_=e; cv_.notify_all(); cv_.wait(l,[&]{return !slot_;}); }
 ...
 ::jxx::Ptr<E> take() override {if(::jxx::lang::Thread::interrupted()) throw ::jxx::lang::InterruptedException();std::unique_lock<std::mutex>l(m_);++waitingConsumers_;cv_.notify_all();cv_.wait(l,[&]{return slot_!=nullptr;});auto r=slot_;slot_.reset();--waitingConsumers_;cv_.notify_all();return r;}
