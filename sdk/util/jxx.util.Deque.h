...
public:
    ...
    virtual void addFirst(const jxx::Ptr<E> e) = 0;
    virtual void addLast(const jxx::Ptr<E> e) = 0;
    virtual jxx::lang::jbool offerFirst(const jxx::Ptr<E> e) = 0;
    virtual jxx::lang::jbool offerLast(const jxx::Ptr<E> e) = 0;
    ...
    virtual jxx::lang::jbool removeFirstOccurrence(const jxx::Ptr<jxx::lang::Object> o) = 0;
    virtual jxx::lang::jbool removeLastOccurrence(const jxx::Ptr<jxx::lang::Object> o) = 0;

    // Queue bridge methods
    virtual jxx::lang::jbool offer(const jxx::Ptr<E> e) override { return offerLast(e); }
