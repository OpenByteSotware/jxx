...
jxx::Ptr<ResourceBundle> ResourceBundle::getBundle(const jxx::Ptr<jxx::lang::String>& baseName,
    ...
    if (loc->getLanguage()->equals(StringPool::intern("fr")) &&
        ...
        return nullptr; // std::static_pointer_cast<ResourceBundle>(jxx::NEW<jxx::examples::messages::Messages_fr_FR>());
    }
    return nullptr; //std::static_pointer_cast<ResourceBundle>(jxx::NEW<jxx::examples::messages::Messages_en_US>());
}
