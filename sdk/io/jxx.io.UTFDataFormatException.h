...
class UTFDataFormatException : public ::jxx::lang::ClassBase<UTFDataFormatException, IOException> {
public:
    using JxxSuper = IOException;
    using Super = ::jxx::lang::ClassBase<UTFDataFormatException, JxxSuper>;
