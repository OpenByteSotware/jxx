...
PrintWriter::PrintWriter(jxx::Ptr<Writer> w, bool autoFlush_) : out(std::move(w)), autoFlush(autoFlush_) {}
PrintWriter::PrintWriter(jxx::Ptr<OutputStream> os, bool autoFlush_, const std::string& charset) : 
