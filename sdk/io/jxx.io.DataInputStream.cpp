...
namespace jxx::io
{
	...
	{
    return synchronized([&]() -> ::jxx::lang::jbyte {
	...
	{
    return synchronized([&]() -> ::jxx::lang::jshort {
	...
	{
    return synchronized([&]() -> ::jxx::lang::jchar {
	...
	{
    return synchronized([&]() -> ::jxx::lang::jfloat {
	...
	{
    return synchronized([&]() -> ::jxx::lang::jdouble {
    ...
    auto size = i->readUnsignedShort();
    auto b = ::jxx::NEW<::jxx::lang::ByteArrayType>(
        static_cast<std::uint32_t>(size));
    i->readFully(b);
    return ModifiedUTF::decode(b);
}
}
