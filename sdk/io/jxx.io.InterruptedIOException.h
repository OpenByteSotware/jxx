...
class InterruptedIOException : public ::jxx::lang::ClassBase<InterruptedIOException, IOException> {
public:
    using JxxSuper = IOException;
    using Super = ::jxx::lang::ClassBase<InterruptedIOException, JxxSuper>;
