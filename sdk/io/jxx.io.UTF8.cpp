...
shared_ptr<jxx::lang::ByteArray> UTF8::encode(const std::u16string& s){
...
std::u16string UTF8::decode(const jxx::lang::ByteArray& bytes){ std::u16string out; size_t i=0,n=bytes.size(); while(i<n){ uint8_t b0=bytes[i++]; uint32_t cp=0; int trail=0;
