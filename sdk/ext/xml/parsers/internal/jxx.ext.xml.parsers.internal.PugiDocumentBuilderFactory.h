...
class PugiDocumentBuilderFactory final
    : public ::jxx::lang::ClassBase<
          PugiDocumentBuilderFactory,
          DocumentBuilderFactory> {
public:
    using JxxSuper = DocumentBuilderFactory;
    using Super = ::jxx::lang::ClassBase<PugiDocumentBuilderFactory, JxxSuper>;

    PugiDocumentBuilderFactory();
    ~PugiDocumentBuilderFactory() override;

    ::jxx::Ptr<DocumentBuilder> newDocumentBuilder() override;
    void setAttribute(
