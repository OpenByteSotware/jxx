...
public:
    ...
    ::jxx::Ptr<::jxx::ext::xml::namespace_::QName> getName() const override {
        return name_;
    }

    ::jxx::Ptr<::jxx::lang::ClassAny> getDeclaredType() const override {
        return declaredType_;
    }

    ::jxx::Ptr<::jxx::lang::ClassAny> getScope() const override {
        return scope_;
    }

    ::jxx::Ptr<T> getValue() const { return value_; }

    ::jxx::Ptr<::jxx::lang::Object> getValueObject() const override {
        return ::jxx::CAST<::jxx::lang::Object>(value_);
    }

    void setValue(const ::jxx::Ptr<T>& value) { value_ = value; }

    ::jxx::lang::jbool isNil() const noexcept override {
        return nil_ || value_ == nullptr;
    }

    void setNil(::jxx::lang::jbool value) noexcept override { nil_ = value; }

    ::jxx::lang::jbool isGlobalScope() const noexcept override {
        return scope_ == nullptr;
    }

    ::jxx::lang::jbool isTypeSubstituted() const override {
