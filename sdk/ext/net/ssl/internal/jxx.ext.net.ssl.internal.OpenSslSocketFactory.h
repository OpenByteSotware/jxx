...
class OpenSslSocketFactory final:public ::jxx::lang::ClassBase<OpenSslSocketFactory,::jxx::ext::net::ssl::SSLSocketFactory>{public:
...
::jxx::Ptr<::jxx::net::Socket> createSocket(const ::jxx::Ptr<::jxx::net::Socket>&,const ::jxx::Ptr<::jxx::lang::String>&,::jxx::lang::jint,::jxx::lang::jbool)override;};}
