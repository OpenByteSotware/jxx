...
::jxx::Ptr<SSLSessionContext> SSLContext::getClientSessionContext(){return nullptr;}
::jxx::Ptr<SSLSessionContext> SSLContext::getServerSessionContext(){return nullptr;}
