...
jxx::lang::String::String(const char* s) { this->assign_from_cstr(s); }    
//explicit String(const char* s, const Allocator& a = Allocator());

jxx::lang::String::String(std::string_view sv) {
    this->assign_from_span(sv.data(), sv.size());
}

// From UTF-16 view (C++17 has basic_string_view)
jxx::lang::String::String(std::u16string_view sv) : data_(sv) {}
// Convert UTF-8 const char* to UTF-16 std::u16string
std::u16string jxx::lang::String::utf8_to_utf16(const char* utf8_str) {
    if (!utf8_str) {
...
// Copy constructor
jxx::lang::String::String(const String& other)
    : data_(other.data_),
    hash_cached_(other.hash_cached_),
    hash_cache_(other.hash_cache_) {}

// Copy assignment operator
jxx::lang::String& jxx::lang::String::operator=(const String& other) {
    if (this != &other) {
        data_ = other.data_;
        hash_cached_ = other.hash_cached_;
        hash_cache_ = other.hash_cache_;
...
// ---- Encoding interop ----
std::string jxx::lang::String::toUtf8() const {
    return jxx::lang::String::utf16ToUtf8(data_);
}

std::string jxx::lang::String::toStdString() const {
    return std::string((const char*)this->data_.c_str());
}

// Semantically similar to String.format(Locale, String, Object...)
jxx::lang::String jxx::lang::String::formatLocale(const std::locale& loc, const std::string& format, const std::vector<std::string>& args) {
    ...
    return jxx::lang::String(std::string(buf.get(), buf.get() + size - 1));
}

// ---- Core Java-like API ----
// length(): number of UTF-16 code units (like Java String.length())
int jxx::lang::String::length() const {
...
bool jxx::lang::String::isEmpty() const { return data_.empty(); }

char16_t jxx::lang::String::charAt(int index) const {
    checkIndexInclusive(index, 0, length() - 1, "charAt index out of range");
    return data_[static_cast<size_t>(index)];
}

// substring(begin)
jxx::lang::String jxx::lang::String::substring(int beginIndex) const {
    return substring(beginIndex, length());
}

// substring(begin, end) with Java semantics
jxx::lang::String jxx::lang::String::substring(int beginIndex, int endIndex) const {
    if (beginIndex < 0 || endIndex < beginIndex || endIndex > length()) {
        throw std::out_of_range("substring indices out of range");
    }
    return jxx::lang::String(std::u16string(data_.begin() + beginIndex, data_.begin() + endIndex));
}

bool jxx::lang::String::startsWith(const jxx::lang::String& prefix) const { return startsWith(prefix, 0); }

bool jxx::lang::String::startsWith(const jxx::lang::String& prefix, int toffset) const {
...
bool jxx::lang::String::endsWith(const jxx::lang::String& suffix) const {
    if (suffix.length() > length()) return false;
    return std::equal(suffix.data_.rbegin(), suffix.data_.rend(), data_.rbegin());
}

// indexOf (string)
int jxx::lang::String::indexOf(const jxx::lang::String& str) const { return indexOf(str, 0); }

int jxx::lang::String::indexOf(const jxx::lang::String& str, int fromIndex) const {
...
// indexOf (char)
int jxx::lang::String::indexOf(char16_t ch) const { return indexOf(ch, 0); }

int jxx::lang::String::indexOf(char16_t ch, int fromIndex) const {
    if (fromIndex < 0) fromIndex = 0;
    if (fromIndex > length()) return -1;
...
// lastIndexOf (string)
int jxx::lang::String::lastIndexOf(const jxx::lang::String& str) const { return lastIndexOf(str, length()); }

int jxx::lang::String::lastIndexOf(const jxx::lang::String& str, int fromIndex) const {
...
// lastIndexOf (char)
int jxx::lang::String::lastIndexOf(char16_t ch) const { return lastIndexOf(ch, length() - 1); }

int jxx::lang::String::lastIndexOf(char16_t ch, int fromIndex) const {
...
bool jxx::lang::String::equals(const jxx::lang::String& other) const { return data_ == other.data_; }

bool jxx::lang::String::equalsIgnoreCase(const jxx::lang::String& other) const {
...
int jxx::lang::String::compareTo(const jxx::lang::String& other) const {
    const auto& a = data_;
...
int jxx::lang::String::compareToIgnoreCase(const jxx::lang::String& other) const {
    // ASCII-only folding
...
jxx::lang::String jxx::lang::String::toLowerCase() const {
    std::u16string out = data_;
    for (auto& c : out) c = asciiLower(c);
    return String(std::move(out));
}

jxx::lang::String jxx::lang::String::toUpperCase() const {
    std::u16string out = data_;
    for (auto& c : out) c = asciiUpper(c);
    return jxx::lang::String(std::move(out));
}

// trim(): Java's original trim (<= U+0020)
jxx::lang::String jxx::lang::String::trim() const {
...
// replace(char, char)
jxx::lang::String jxx::lang::String::replace(char16_t oldChar, char16_t newChar) const {
...
jxx::lang::String jxx::lang::String::replace(const jxx::lang::String& target, const jxx::lang::String& replacement) const {
...
std::vector<jxx::lang::String> jxx::lang::String::split(const jxx::lang::String& regex, int limit = 0) const {
...
jxx::lang::String jxx::lang::String::concat(const jxx::lang::String& other) const {
