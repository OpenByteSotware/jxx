...
::jxx::Ptr<::jxx::lang::Object> TypeAdapter::fromJson(const ::jxx::Ptr<::jxx::io::Reader>& reader){if(reader==nullptr)throw ::jxx::lang::NullPointerException();return read(::jxx::NEW<::com::google::gson::stream::JsonReader>(reader));}
void TypeAdapter::toJson(const ::jxx::Ptr<::jxx::io::Writer>& writer,const ::jxx::Ptr<::jxx::lang::Object>& value){if(writer==nullptr)throw ::jxx::lang::NullPointerException();const auto stream=::jxx::NEW<::com::google::gson::stream::JsonWriter>(writer);write(stream,value);stream->flush();}
