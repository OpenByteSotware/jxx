...
public:
 ...
 DefaultHttpServer(); DefaultHttpServer(const ::jxx::Ptr<::jxx::net::InetSocketAddress>&addr,::jxx::lang::jint backlog); DefaultHttpServer(const ::jxx::Ptr<::jxx::net::ServerSocket>& listener,const ::jxx::Ptr<::jxx::net::InetSocketAddress>& address);~DefaultHttpServer()override;
...
private:void acceptLoop();void serve(const ::jxx::Ptr<::jxx::net::Socket>&socket);::jxx::Ptr<::jxx::com::sun::net::httpserver::HttpContext>match(const std::string&path);
 ::jxx::Ptr<::jxx::net::ServerSocket>serverSocket_;::jxx::Ptr<::jxx::net::InetSocketAddress>address_;::jxx::Ptr<::jxx::util::concurrent::Executor>executor_;std::mutex mutex_;std::vector<::jxx::Ptr<::jxx::com::sun::net::httpserver::HttpContext>>contexts_;std::atomic<bool>running_{false};std::thread acceptThread_;std::vector<std::thread>workers_;
}; }
